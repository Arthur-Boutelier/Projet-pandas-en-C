...
/*
 * Cette fonction permet de donner le nombre de valeur étant égal à la valeur entrée
 * Entrée : col : COLONNE*, pointeur visant la colonne
 *          valeur : void*, pointeur visant sur une valeur
 * Sortie : long long int, correspondant au nombre de valeur égal à la valeur entrée
 */
